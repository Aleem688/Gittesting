...
import io.github.bonigarcia.wdm.WebDriverManager;
	...
	public class SystemEditTestCase extends BaseClass {
		
		@Test
		public void EditUserRegistration() throws Throwable
		{
...
//	
	...
	/*String FULLNAME = elib.readDataFromExcel("Individual", 0, 1);
	String MOBILE = elib.readDataFromExcel("Individual", 1, 1);
	String ALTERNATEMOBILE = elib.readDataFromExcel("Individual", 2, 1);
	String EMAIL = elib.readDataFromExcel("Individual", 3, 1);
	String PLOTNO = elib.readDataFromExcel("Individual", 4, 1);
	String AVAILABLEROOMS = elib.readDataFromExcel("Individual", 5, 1);
	String COUNTRY = elib.readDataFromExcel("Individual", 6, 1);
	String STATE = elib.readDataFromExcel("Individual", 7, 1);
	String CITY = elib.readDataFromExcel("Individual", 8, 1);
	String RENT = elib.readDataFromExcel("Individual", 9, 1);
	String DEPOSITE = elib.readDataFromExcel("Individual", 10, 1);
	String ADDRESS = elib.readDataFromExcel("Individual", 11, 1);
	String VACANT = elib.readDataFromExcel("Individual", 12, 1);
...
//	         }
	   ...
	   HashMap<String, String> map = elib.getMultipleDataFromExcel("Individual", 0, 1);
...
/*
	...
	driver.findElement(By.xpath("(//input[@id='alternat_mobile'])[1]")).sendKeys(ALTERNATEMOBILE);
	driver.findElement(By.xpath("(//input[@id='email'])[1]")).sendKeys(EMAIL);
	driver.findElement(By.xpath("(//input[@id='plot_number'])[1]")).sendKeys(PLOTNO);
	driver.findElement(By.xpath("(//input[@id='rooms'])[1]")).sendKeys(AVAILABLEROOMS);
	...
	*/
	...
	WebElement element = driver.findElement(By.xpath("(//p[contains(text(),'Megha')]/ancestor::div[@class='card-block']/a[text()='Edit'])[1]"));
	try {
	JavascriptExecutor js=(JavascriptExecutor)driver;
	js.executeScript("arguments[0].scrollIntoView(true)", element);
	js.executeScript("window.scrollBy(0,-100)","");
	Thread.sleep(3000);
//	driver.findElement(By.xpath("//p[text()='admin@adddin.com']/ancestor::div[@class='card card-inverse card-info mb-3']/descendant::a[text()='Edit']")).click();
	element.click();
	}
	catch(Exception e)
	{
